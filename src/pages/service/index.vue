	...
	<view class="content">
		...
		<swiper class="swiper-style" indicator-dots="true" :autoplay="true" :circular="true" :interval="2000" :duration="500">
			<swiper-item v-for="(item,index) in swipeArr" :key="index" style="justify-content: center;background-color: #000000;">
				<image @click="bannerClick(item.bannerCopywritingUrl)" :src="decodeURIComponent(item.bannerUrl)" v-bind:style="{width: imageWidth + 'px'}"  mode="scaleToFill"></image>
			</swiper-item>
		</swiper>
	...
	export default {
		data() {
			...
			return {
				...
				cardBars: [
					{title: "寄养", id: '0', gotoUrl:"foster/index", ico:"../../static/service/foster-mine.png" },
					{title: "领养", id: '1', gotoUrl:"adopt/index", ico:"../../static/service/adopt-mine.png"  },
					{title: "配对", id: '2', gotoUrl:"pair/index", ico:"../../static/service/pair-mine.png"  },
		...
		// mounted() {
		// 	window.addEventListener("scroll",this.getScroll_service); 
		// },
		// destroyed () {
		// 	window.removeEventListener('scroll', this.getScroll_service)
		// },
		methods: {
			// //监听滚动
			// getScroll_service(){
			...
			// 	if (!!document.documentElement.scrollTop &&document.documentElement.scrollTop >=210){            
