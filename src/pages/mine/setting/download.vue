	...
	<view class="content">
		<view style="padding: 0 60upx;flex-direction: column;">
			<view style="flex-direction: column;width: 100%;align-items: center;margin-top: 15%;">
				<image style="width: 160upx;height: 160upx;" src="@/static/logo.jpg"></image>
				<text style="margin-top: 40upx;line-height: 80upx;font-size: 46upx;font-weight: 700;">养宠物，选甜宠</text>
				<text style="line-height: 40upx;font-weight: 700;color: #b7b7b7;">一生为你，一心为它</text>
			</view>
