<template>
	<view class="content">
		...
		<view style="flex-direction: column;width: 100%;margin-top: 8upx;">
			<view @click="petMessage" style="flex-direction: row;width: 100%;height: 100upx;line-height: 100upx;background-color: #FFFFFF;padding: 20upx 40upx;">
		...
		<view style="flex-direction: column;width: 100%;margin-top: 2upx;">
			<view @click="noticeMessage" style="flex-direction: row;width: 100%;height: 100upx;line-height: 100upx;background-color: #FFFFFF;padding: 20upx 40upx;">
				<view style="width: 40%;height: 100%;align-items: center;">
		...
		<view style="flex-direction: column;width: 100%;margin-top: 2upx;">
			<view @click="officialMessage" style="flex-direction: row;width: 100%;height: 100upx;line-height: 100upx;background-color: #FFFFFF;padding: 20upx 40upx;">
				<view style="width: 40%;height: 100%;align-items: center;">
...
<script>
	...
	export default{
		...
		methods: {
			trackEvent(){
				// #ifdef MP-WEIXIN
				wx.uma.trackEvent(this.calculation.umeng_event_tab_message);
				// #endif
				// #ifdef MP-QQ
				qq.uma.trackEvent(this.calculation.umeng_event_tab_message);
				// #endif
				// #ifdef MP-TOUTIAO
				tt.uma.trackEvent(this.calculation.umeng_event_tab_message);
				// #endif
				// #ifdef MP-BAIDU
				swan.uma.trackEvent(this.calculation.umeng_event_tab_message);
				// #endif
			},
			//当前用户未处理的计划通知数
			...
			thumbsupMessage(){
				...
				if(token){
					uni.navigateTo({
						url:'/pages/mine/msg/msg-thumbsup'
					})
				}else{
					uni.navigateTo({
			...
			favoriteMessage(){
				...
				if(token){
					uni.navigateTo({
						url:'/pages/mine/msg/msg-favorite'
					})
				}else{
					uni.navigateTo({
						url:'/pages/mine/login/account-login'
			...
			commentMessage(){
				...
				if(token){
					uni.navigateTo({
						url:'/pages/mine/msg/msg-comment'
					})
				}else{
					uni.navigateTo({
						url:'/pages/mine/login/account-login'
			...
			petMessage(){
				...
				if(token){
					uni.navigateTo({
						url:'/pages/mine/msg/msg-pet-plan?type=0'
					})
				}else{
					uni.navigateTo({
						url:'/pages/mine/login/account-login'
			...
			noticeMessage(){
				...
				if(token){
					uni.navigateTo({
						url:'/pages/mine/msg/msg-notification'
					})
				}else{
					uni.navigateTo({
						url:'/pages/mine/login/account-login'
			...
			officialMessage(){
				...
				if(token){
					uni.navigateTo({
						url:'/pages/mine/msg/msg-officia'
					})
				}else{
					uni.navigateTo({
						url:'/pages/mine/login/account-login'
